...
{
    return ((local_monster == state.local_monster) && (local_monk == state.local_monk) && (remote_monster == state.remote_monster) && (remote_monk == state.remote_monk) && (boat == state.boat));
}
...
{
    return ((local_monster == 0) && (local_monk == 0) && (remote_monster == monster_count) && (remote_monk == monk_count) && (boat == REMOTE));
}
